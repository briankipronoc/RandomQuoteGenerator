...
plugins {
    ...
    kotlin("kapt") // Keep this as kotlin("kapt")
    id("com.google.dagger.hilt.android")
}

android {
    namespace = "com.kiprono.randomquote" // Ensure this matches your package name
    compileSdk = 34
...
dependencies {
    ...
    implementation("androidx.datastore:datastore-preferences:1.1.1") // Ensure this is present and correct
}